...
#region Attach
	...
	static void AddIfMissing<T> () where T : Component
	{
		...
		{
			for (int i = 0; i < Selection.gameObjects.Length; ++i)
				Selection.gameObjects[i].GetComponentForce<T>();
		}
		else Debug.Log("You must select a game object first.");
	}
...
#region Tweens
	...
	static void Tween1 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenAlpha>(); }
	...
	static void Tween2 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenColor>(); }
	...
	static void Tween3 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenWidth>(); }
	...
	static void Tween4 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenHeight>(); }
	...
	static void Tween5 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenPosition>(); }
	...
	static void Tween6 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenRotation>(); }
	...
	static void Tween7 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenScale>(); }
	...
	static void Tween8 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenTransform>(); }
	...
	static void Tween9 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenVolume>(); }
	...
	static void Tween10 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenFOV>(); }
	...
	static void Tween11 () { if (Selection.activeGameObject != null) Selection.activeGameObject.GetComponentForce<TweenOrthoSize>(); }
